...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String CLIENT_MASTER_KEY = "swordmaster"; // your master key
    ...
    private static final int EXTRA_CLIENT_ID_VALUE = 81; // your client id
    private static final String EXTRA_SERVICE_VALUE = "Test Bank"; // service name to be displayed
    private static final String EXTRA_USER_CODE_VALUE = "1KJNJZL"; // user FIN code
